        ...
        <div class="panel panel-red">
            <div class="panel-heading">
                <div class="row">
                    ...
                    $category_count=mysqli_num_rows($categories_count_query);
           ...
           <?php 
            ...
            $query="SELECT * FROM gposts WHERE gpost_status='draft' ";
            ...
            $subscriber_count=mysqli_num_rows($user_subscriber_query);
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ['Data', 'Count'],
            ...
            <?php 
            $elements=['All Posts','Active Posts','Draft Posts','Comments','Unapproved Comments','Users','Subscribers','Categories'];
            $element_data=[$post_count,$published_post_count,$draft_post_count,$comment_count,$unapproved_comment_count,$user_count,$subscriber_count,$category_count];
